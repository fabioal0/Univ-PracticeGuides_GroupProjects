...
public class KeyValueList<E> {
   ...
   * @param start the start delimitor
   * @param mid the item separator
   * @param end the end delimitor
      ...
      // Call a more versatile version with the proper delimiters and separator:
  {
    ...
    String str2 = "";
    for (KeyValueNode<E> localKeyValueNode = this.first; localKeyValueNode != null; localKeyValueNode = localKeyValueNode.next)
    {
      str2 = str2 + paramString2 + localKeyValueNode.toString();

    }
    return paramString1 + str2 + paramString3;
