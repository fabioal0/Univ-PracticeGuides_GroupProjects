...
public class HashTable<E> {
 ...
 public String[] keys()
  {
    String[] arrayOfString1 = new String[this.size];
    int i = 0;
    for (int j = 0; j < this.array.length; j++)
    {
      String[] arrayOfString2 = this.array[j].keys();
      for (int k = 0; k < arrayOfString2.length; k++)
      {
        arrayOfString1[i] = arrayOfString2[k];
        i++;
      }
    }
    assert (i == this.size);
  ...
  public String toString(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (int i = 0; i < this.array.length; i++) {
      ...
      {
        String str3 = this.array[i].toString("", paramString2, "");
        str1 = str1 + str2 + str3;
        str2 = paramString2;
      }
    }
    return paramString1 + str1 + paramString3;
  }
}
