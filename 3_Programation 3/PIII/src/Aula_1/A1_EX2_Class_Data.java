...
public class A1_EX2_Class_Data {
    
    private final int Dia;
    private final int Mes; 
    private final int Ano;
    
    public A1_EX2_Class_Data (int Dia ,int Mes ,int Ano) {
    ...
    public static A1_EX2_Class_Data Today(){
        
        GregorianCalendar Calendar=new GregorianCalendar();   
        
        A1_EX2_Class_Data today = new A1_EX2_Class_Data(Calendar.get(GregorianCalendar.DAY_OF_MONTH),Calendar.get(GregorianCalendar.MONTH),Calendar.get(GregorianCalendar.YEAR));
    ...
    public boolean equals(Object obj) {
        ...
        final A1_EX2_Class_Data other = (A1_EX2_Class_Data) obj;
