...
#define T_T3_MASK  0x00001000    


// TIMER 
#define PS_VALUE 3
#define PERIOD_VALUE 625


// TIMER PWM VALUES
#define PWM_PERIOD_PS_VALUE 0
#define PWM_PERIOD_VALUE 10000
#define PWM_TON_VALUE 100
...
# define T1_CLR()    IFS0CLR = T_T3_MASK;
# define T1_SET()    IFS0SET = T_T3_MASK;
# define T1_INV()    IFS0INV = T_T3_MASK;
