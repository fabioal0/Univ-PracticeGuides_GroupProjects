...
void init_tools_pot(ToolsPot* pot, int num_scissors, int num_combs, int num_razors, int line, int column)
{
	...
	pot->toolsPotMutex = PTHREAD_MUTEX_INITIALIZER;
	pot->availableScissor = PTHREAD_COND_INITIALIZER;
	pot->availableComb = PTHREAD_COND_INITIALIZER;
	pot->availableRazor = PTHREAD_COND_INITIALIZER;
}
