     ...
     if( event == cv::EVENT_LBUTTONDOWN )
     {
         switch( (char)CHOICE )
         {
             ...
             case '4' :
                 ...
                 cv::line( GRAY_IMAGE, cv::Point( x - 20, y + 20 ), cv::Point( x + 20, y + 20 ), cv::Scalar( 255 ) );
                 cv::line( GRAY_IMAGE, cv::Point( x - 20, y + 20 ), cv::Point( x - 40, y ), cv::Scalar( 255 ) );
                 cv::line( GRAY_IMAGE, cv::Point( x - 40, y ), cv::Point( x, y - 20 ), cv::Scalar( 255 ) );
                 cv::line( GRAY_IMAGE, cv::Point( x, y - 20 ), cv::Point( x + 40, y ), cv::Scalar( 255 ) );
                 cv::line( GRAY_IMAGE, cv::Point( x + 40, y ), cv::Point( x + 20, y + 20 ), cv::Scalar( 255 ) );
     ...
     if( event == cv::EVENT_LBUTTONDOWN )
     {
         switch( (char)CHOICE )
         {
             ...
             case '4' :
                 ...
                 //cv::line( RGB_IMAGE, cv::Point( x - 20, y + 20 ), cv::Point( x + 20, y + 20 ), cv::Scalar( 255 ) );
                 //cv::line( RGB_IMAGE, cv::Point( x - 20, y + 20 ), cv::Point( x - 40, y ), cv::Scalar( 255 ) );
                 //cv::line( RGB_IMAGE, cv::Point( x - 40, y ), cv::Point( x, y - 20 ), cv::Scalar( 255 ) );
                 //cv::line( RGB_IMAGE, cv::Point( x, y - 20 ), cv::Point( x + 40, y ), cv::Scalar( 255 ) );
                 //cv::line( RGB_IMAGE, cv::Point( x + 40, y ), cv::Point( x + 20, y + 20 ), cv::Scalar( 255 ) );

                 cv::Point array[20];
                 array[0] = cv::Point( x - 20, y + 20 );
                 array[1] = cv::Point( x + 20, y + 20 );
                 array[2] = cv::Point( x - 40, y );
                 array[3] = cv::Point( x, y - 20 );
                 array[4] = cv::Point( x + 40, y );

                 cv::fillPoly( RGB_IMAGE,  array, cv::Scalar(255) );
    ...
    for( ; ; )
    {
        ...
        switch( (char)CHOICE )
        {
            ...
            case '4' :
                ...
                std::cout << "Pentagon : Select the center with the mouse LEFT BUTTON" << std::endl;
