...
lightSources[2].setPosition( 0, 0, 1.0, 1.0 );
...
lightSources[3].setPosition( 0.0, -1, 0.0, 1.0 );

lightSources[3].setIntensity( 1.0, 1.0, 1.0 );

lightSources[3].setAmbIntensity( 0.5, 0.5, 0.5 );

lightSources[3].switchRotXXOn();

lightSources[3].setRotationSpeed( -2 );
