...
int main (int argc, char *argv[])
{
	...
	for (Vert = 1; Vert <= NVertices; Vert++)
	{
		...
		switch (Erro)
		{
			case OK     : printf ("vertice %u normal\n", Vert);  break;
			case SINK   : printf ("vertice %u sumidouro\n", Vert);  break;
			case SOURCE : printf ("vertice %u fonte\n", Vert);  break;
			case DISC   : printf ("vertice %u desconexo\n", Vert);  break;
	...
	for (Vert = 1; Vert <= NVertices; Vert++)
	{
		...
		else printf ("Media de sucessores dos sucessores do vertice %u = %f\n", Vert, Central);
	}
	printf ("---------------------------------------------------------------\n");
	...
	for (Vert = 1; Vert <= NVertices; Vert++)
	{
		...
		{
			printf("Vertices predecessores do vertice %u", Vert);
