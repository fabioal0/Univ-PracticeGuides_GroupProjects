...
int main (void)
{
  PtSeqArray SequenceArray[MAX_ARRAYS]; 
  char FileName[21]; 
  double Average;
  int Option, Equals, Dim, Size, Index, Value, Count, Smaller, Bigger, Order; 
  unsigned int Sequence1, Sequence2;
  ...
  do
  {
    ...
    switch (Option)
    {
        ...
        case 7 :  Sequence1 = ReadSequenceIndex ("primeira sequencia");
                  ...
                  {
                      if (Equals) printf("\e[31;1f| \e[1mAs sequencias %u e %u sao iguais", Sequence1, Sequence2);
                      else printf("\e[31;1f| \e[1mAs sequencias %u e %u nao sao iguais", Sequence1, Sequence2);
